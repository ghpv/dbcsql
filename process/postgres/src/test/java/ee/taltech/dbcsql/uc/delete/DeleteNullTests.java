...
public class DeleteNullTests extends UseCaseTest
{
	...
	preconditions
	{
		exists vardata a (col_int1 is null);
	}
	postconditions
	{
		deleted a;
	...
	public void test()
	{
		...
		this
			.exec("insert into vardata (col_int1) values (null), (3)")
			.exec("select forget_vardata()")
			.assertQuery(
				"select col_int1 from vardata order by col_int1",
				List.of(List.of(3)),
				"null should have gotten deleted"
			)
		;
	}
}
